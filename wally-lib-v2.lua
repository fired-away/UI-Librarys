...
local defaults; do
    ...
    local types = {}; do
        ...
        function types:Toggle(name, options, callback)
            ...
            check:FindFirstChild(name).Holder.Checkmark.Parent = check:FindFirstChild(name).Holder
            ...
            local function click(t)
                ...
                TweenService:Create(check:FindFirstChild(name).Holder.Checkmark, TweenInfo.new(0.12, Enum.EasingStyle.Quad), goal):Play()
            end
            
            check:FindFirstChild(name).Holder.MouseButton1Click:connect(click)
        ...
        function types:Button(name, callback)
            ...
            button.InputBegan:connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseMovement then
                    inContact = true
                    TweenService:Create(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}):Play()
                end
            end)
            ...
            button.InputEnded:connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseMovement then
                    inContact = false
                    TweenService:Create(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(25, 25, 25)}):Play()
                end
            end)
