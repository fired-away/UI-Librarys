...
local a = library:NewWindow("ok","HUB") -- Change to anything
...
local maincolor = Color3.fromRGB(0, 177, 255)
local firstpage = ""
...
function library:NewWindow(text, hub)
    ...
    TH.Name = "TH"
    TH.Parent = MainWindow
    TH.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    TH.BackgroundTransparency = 1
    TH.Position = UDim2.new(0.04, 0, 0.03, 0)
    TH.Size = UDim2.new(0, 43, 0, 21)
    TH.Font = Enum.Font.ArialBold
    TH.Text = text
